...
# sensor-read-once.py - Read CO2, temperature, pressure, and humidity ONCE
...
# Dummy reads for BME280 (discard values)
_ = bme280.get_temperature()
_ = bme280.get_pressure()
_ = bme280.get_humidity()
time.sleep(0.5)  # Wait for sensor to update

# Actual BME280 reading
